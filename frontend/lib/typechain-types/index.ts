...
export type { RaceChainBetting } from "./contracts/RaceChainBetting";
export { RaceChainBetting__factory } from "./factories/contracts/RaceChainBetting__factory";
export type { TestRaceCoin } from "./contracts/TestRaceCoin";
export { TestRaceCoin__factory } from "./factories/contracts/TestRaceCoin__factory";
